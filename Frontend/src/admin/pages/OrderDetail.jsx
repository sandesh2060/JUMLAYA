...
// ============================================
// IMAGE URL HELPER (Handles /api in VITE_API_URL)
// ============================================
const getImageUrl = (imageUrl) => {
  ...
  const baseUrl = apiUrl.replace(/\/api\/?$/, ""); // Remove /api from end
...
const OrderDetail = () => {
  ...
  const fetchOrder = async () => {
    ...
    try {
      ...
      // Debug image paths
      console.log("🖼️ Order items images:", response.data.order.items.map(item => ({
        name: item.name,
        ...
        <div id="printable-order">
          ...
          <div className="hidden print:block mb-6">
            <div className="text-center border-b-2 border-gray-300 pb-4 mb-4">
              <h1 className="text-3xl font-bold text-gray-900">JUMLAYA</h1>
            ...
            <div className="flex justify-between items-start mb-6">
              ...
              <div className="text-right">
                <div className="inline-block px-4 py-2 rounded-lg border-2 border-gray-300 font-bold text-gray-900">
                  {order.orderStatus}
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              {/* Order Items */}
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 print-border">
                <h2 className="text-lg font-semibold mb-4 flex items-center gap-2">
                  <Package className="w-5 h-5 no-print" />
                  Order Items
                </h2>
                  ...
                  {order.items.map((item, index) => (
                    ...
                    >
                      <img
                        ...
                        alt={item.name}
                        className="w-20 h-20 object-cover rounded no-print"
                        onError={(e) => {
              ...
              {/* Status History */}
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 print-border no-print">
                <h2 className="text-lg font-semibold mb-4 flex items-center gap-2">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 print-border">
                <h2 className="text-lg font-semibold mb-4 flex items-center gap-2">
                  <User className="w-5 h-5 no-print" />
                  Customer
                </h2>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 print-border">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-lg font-semibold flex items-center gap-2">
                    <CreditCard className="w-5 h-5 no-print" />
                    Payment
                  </h2>
                  {!editingPayment && (
                    <button
                      onClick={() => setEditingPayment(true)}
                      className="p-1 hover:bg-gray-100 dark:hover:bg-gray-700 rounded no-print"
                    >
              ...
              {/* Update Status - Hide on print */}
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 no-print">
                <div className="flex items-center justify-between mb-4">
