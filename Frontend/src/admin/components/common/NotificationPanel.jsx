// ============================================
// FILE 4: NotificationPanel.jsx (ADMIN)
// Path: Frontend/src/admin/components/common/NotificationPanel.jsx
// ============================================
import { useState, useEffect, useRef } from 'react';
import { Bell, Check, CheckCheck, Trash2, X } from 'lucide-react';
import { useNotification } from '@/hooks/useNotification'; // ✅ Use shared hook
...
const NotificationPanel = () => {
  ...
  const getNotificationColor = (type) => {
    const colorMap = {
      ...
      product: 'bg-green-100 text-green-600 dark:bg-green-900/20 dark:text-green-400',
  ...
  return (
    <div className="relative" ref={panelRef}>
      <button
        ...
        className="relative p-2 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white focus:outline-none focus:ring-2 focus:ring-primary-500 rounded-lg transition-colors"
